...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const login = async (email: string, password: string, isAdminLogin = false) => {
    ...
    try {
      ...
      // 5. 合并profile查询：一次获取完整profile信息，避免重复查询
