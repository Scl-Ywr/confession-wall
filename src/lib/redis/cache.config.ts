...
export const MODULE_EXPIRY = {
  ...
  // 评论相关（新增）
  COMMENT_LIST: CACHE_EXPIRY.SHORT,      // 5分钟 - 频繁更新
  COMMENT_DETAIL: CACHE_EXPIRY.MEDIUM,   // 1小时 - 中等更新频率
  COMMENT_COUNT: CACHE_EXPIRY.SHORT,     // 5分钟 - 实时性要求高
  COMMENT_USER_HISTORY: CACHE_EXPIRY.SHORT, // 5分钟 - 用户评论历史

  // 搜索相关（新增）
  SEARCH_RESULT: CACHE_EXPIRY.MEDIUM,      // 1小时 - 搜索结果变化较慢
  SEARCH_TRENDING: CACHE_EXPIRY.SHORT,     // 5分钟 - 热门搜索需实时
  SEARCH_SUGGESTION: CACHE_EXPIRY.MEDIUM,  // 1小时 - 搜索建议变化慢
} as const;
